...
set contactus_url [export_vars -base "/mail/contact-us" {{return_url [ad_return_url]}}]

# Redirect to videos search page results
set package_key [ad_conn package_key]
set videos_p 0
if {$package_key == "videos"} { set videos_p 1 }



set gmt_time [db_string select_current_time {
    SELECT now();
}]
