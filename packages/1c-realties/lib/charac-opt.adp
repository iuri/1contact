...
<div class='input-control' data-role='select' data-allow-clear='true' data-placeholder='#1c-realties.CharacGeneral#' style='width:28em;' >
...
<div class='input-control' data-role='select' data-allow-clear='true' data-placeholder='#1c-realties.CharacArchitecture#' style='width:28em;' >
...
<div class='input-control' data-role='select' data-allow-clear='true' data-placeholder='#1c-realties.CharacNeighbornhood#' style='width:56.25em;' >
