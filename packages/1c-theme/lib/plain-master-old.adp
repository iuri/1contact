...
<table width"100%">
  <tr>
    <td valign="top" align="left"><div style=""><img src="/resources/1c-theme/images/LogoNoir.png" width="100px" border=0></div></td>
    <td valign="top" align="left">
      <table><tr><td>
        <div style="float:left; font-weight:normal; font-size: 10pt;"></div>
