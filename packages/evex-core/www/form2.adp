	 ...
	 <tr><td><br><br><textarea name="body" style="background: transparent;border:0; border-bottom:1px solid #737373; width:100%;" cols="66" rows="4" onfocus="if(this.value == 'Mensagem') { this.value = '';}">Mensagem</textarea></td></tr>
