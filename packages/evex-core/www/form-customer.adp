	 ...
	 <tr><td><br><br><textarea name="body" style="background: transparent;border:0; border-bottom:1px solid #737373; width:100%;" cols="66" rows="4" onfocus="if(this.value == 'Fale mais sobre seu evento (tipo de evento, quantas pessoas, data, etc)') { this.value = '';}">Fale mais sobre seu evento (tipo de evento, quantas pessoas, data, etc)</textarea></td></tr>
