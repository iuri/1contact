...
#	ns_log Notice "$url"
	...
	append html " 
	    ...
	    <form action=\"one\" name=\"video-one\">
	      <input type=\"hidden\" id=\"url\" name=\"url\" value=\"http://www.youtube.com/watch?v=${id}\">
              <input type=\"hidden\" id=\"img\" name=\"img\" value=\"$url\">
              <input type=\"hidden\" id=\"id\" name=\"id\" value=\"$id\">
              <input type=\"hidden\" id=\"title\" name=\"title\" value=\"$title\">
              <input type=\"hidden\" id=\"width\" name=\"width\" value=\"$width\">
              <input type=\"hidden\" id=\"height\" name=\"height\" value=\"$height\">
              <input type=\"hidden\" id=\"average\" name=\"average\" value=\"$average\">
              <input type=\"hidden\" id=\"numlikes\" name=\"numlikes\" value=\"$numlikes\">

              <input class=\"lightview\" type=\"image\" src=\"${url}\" style=\"width:305px;\" alt=\"Submit Button\"><br>$title<br>$average | $numlikes
	    <br>$height | $width</form> </td>
	"
