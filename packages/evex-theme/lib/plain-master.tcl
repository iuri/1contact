...
set contact_url [export_vars -base "/mail/contact-us" {{return_url [ad_return_url]}}]
...
if { $untrusted_user_id == 0 } {
    ...
    set signup_url "/register/user-new?return_url=[ad_return_url]"
} else {
...
# Add javascript
#
template::head::add_javascript -src "vendor/jquery.min.js" 
template::head::add_javascript -src "vendor/noframework.waypoints.min.js"
template::head::add_javascript -src "vendor/jquery.magnific-popup.min.js"
template::head::add_javascript -src "js/responsive-nav.js"
template::head::add_javascript -src "vendor/swiper.jquery.js"
template::head::add_javascript -src "js/form-submit.js"
template::head::add_javascript -src "js/popup.js"
template::head::add_javascript -src "js/reveal-animation.js"
template::head::add_javascript -src "js/bg-videos.js"
template::head::add_javascript -src "js/background-parallax.js"
template::head::add_javascript -src "js/page-script.js"
...
template::head::add_javascript -src "vendor/webfontloader.js"
template::head::add_javascript -src "js/fontloader.js"


# Add CSS
#
template::head::add_css -href "css/base.css" 
