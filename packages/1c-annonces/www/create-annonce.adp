...
<div style='position:relative;' >
	...
	<div class='box' >
		...
		<div class='input-control text' style='width:6em;' >
			<input type='text' name='price' id='price' placeholder='#1c-annonces.Price#' title='#1c-annonces.Price#' min='0' required style='width:100%;' />
		</div>

		<!-- Taxas -->
		<div class='input-control text' style='width:6em;' >
			<input type='text' name='taxes' id='taxes' placeholder='#1c-annonces.Taxes#' title='#1c-annonces.Taxes#' min='0' required style='width:100%;' />
		</div>
	...
	<div class='box' style='vertical-align:top;' >
		...
		<div class='input-control file' data-role='input' >
    		<input type='file' multiple='multiple' title='#1c-annonces.AddFiles#' >
