...
<div style='position:relative;' >
	...
	<div class='box' >
		...
		<div class='input-control text' style='width:5em;' >
			<input type='text' name='announce_price' placeholder='Preço' min='0' style='width:100%;' />
		</div>

		<!-- Taxas -->
		<div class='input-control text' style='width:5em;' >
			<input type='text' name='announce_taxes' placeholder='Taxas' min-='0' style='width:100%;' />
		</div>
