ad_library {
    ...
    @cvs-id $Id: incoming-mail-procs.tcl,v 1.7.2.1 2015/09/10 08:21:31 gustafn Exp $
...
<p>
        ...
        ns_log Notice "Running ad_proc load_mails -queue_dir $queue_dir"
        # get list of all incoming mail
        if {[catch {
            set messages [glob "$queue_dir/new/*"]
            #set messages [glob "$queue_dir/*"]
        } errmsg]} {
            ns_log Notice "I passed here!"
