...
<div class="main">
  <div class="header">
    <div class="logo"><img src="/resources/uzeda-theme/uzeda-logo.PNG" width="300px">&nbsp;</div>
      ...
      <ul>
          ...
          <if @logout_url@ not nil>
            <li><a href="@pvt_home_url@">@pvt_home_name;noquote@</a> | </li>
       	    <if @admin_url@>
              <li><a href="@admin_url@">#uzeda-core.Admin#</a> |</li>
            </if>
	    <li><a href="@logout_url@">#uzeda-core.Log_out#</a></li>
          </if>
      </ul>
    </div>
...
<!--
      <ul>
          <li><a href="/cnauto/site-map">#uzeda-core.SiteMap#</a> |</li> 
      	  <li><a href="/cnauto/content/terms">#uzeda-core.Terms_of_Use#</a> |</li>
          <li><a href="/ivc/site-map">#uzeda-core.Contact_us#</a></li> 
      </ul>
-->
    </div>
  </div>
